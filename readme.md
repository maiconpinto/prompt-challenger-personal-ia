...
Com base nos valores informados na área de variáveis e com as guidelines, crie um treino ideal para a pessoa que corresponde a combinação desses 4 valores. Como Dicas Adicionais, faça uma sugestão da porcentagem de macroalimentos considerando o objetivo dele. Por fim, calcule o IMC dele através das variáveis {{peso}} e {{altura}}, e diga qual seria o peso ideal para o aluno considerando o biotipo dele.
```